                ...
                <td className="py-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="text-sm">
                            <div className="theme-layer-secondary">{user.name}</div>
        ...
        <FlexCol className="gap-6">
            <div className="grid grid-cols-3 gap-4">
                ...
                <Card className="flex flex-col gap-3">
                    ...
                    <div className="theme-layer-secondary text-2xl font-semibold leading-none">4</div>
                ...
                <Card className="flex flex-col gap-3">
                    ...
                    <div className="theme-layer-secondary text-2xl font-semibold leading-none">5</div>
                ...
                <Card className="flex flex-col gap-3">
                    ...
                    <div className="theme-layer-secondary text-2xl font-semibold leading-none">2.4 Days</div>
