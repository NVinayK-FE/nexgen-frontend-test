...
export const InviteUserForm: React.FC<InviteUserFormProps> = ({ onSubmit }) => {
    ...
    return (
        <div className="min-h-screen t-page">
            ...
            <div className="mb-8">
                ...
                <p className="text-slate-500">Add a new team member to your organization</p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-0">
                        ...
                        <div className="space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 rounded-lg text-sm bg-slate-950 border border-slate-700 text-slate-100 placeholder-slate-600 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 outline-none transition-all"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full px-3 py-2 pr-10 rounded-lg text-sm bg-slate-950 border border-slate-700 text-slate-100 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 outline-none transition-all appearance-none"
                                    >
                                ...
                                <p className="mt-2 text-xs text-slate-500">
                                    <strong className="text-blue-400">Can manage properties and users</strong>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-8 border-b border-slate-800/50">
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            ...
                            >
                                <Building2 className={cn("w-5 h-5", scope === "property" ? "text-blue-400" : "text-slate-500")} />
                                <span className={cn("text-sm font-bold", scope === "property" ? "text-slate-100" : "text-slate-500")}>
                                    Specific Hotels
                                </span>
                            </button>
